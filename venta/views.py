...
def cliente_lista_activo(request,page=None,search=None):
    ...
    if search == None or search.strip() == "None" or search.strip() == "":# si la cadena de búsqueda viene vacia
        cliente_array = Cliente.objects.filter(estado_cliente='t').order_by('nombre_cliente')
        
        for cl in cliente_array:
    
            cliente_all.append({'id':cl.id,
                                'rut_cliente':cl.rut_cliente,
                                'nombre_cliente':cl.nombre_completo(),
                                'correo_cliente':cl.correo_cliente,
                                'telefono_cliente':cl.telefono_cliente})
...
def cliente_lista_venta(request,cliente_id,page=None,search=None):
    ...
    if search == None or search.strip() == "None" or search.strip() == "":# si la cadena de búsqueda viene vacia:# si la cadena de búsqueda viene vacia
        ...
        for cl in venta_array:
            ...
            venta_all.append({'id':cl.id,
                            'creacion_venta':cl.creacion_venta,
                            'total_venta':cl.total_venta,
                            'codigo_venta':cl.formatted_codigo_venta})
